...
for i in range(len(images)):
    ...
    noisy[:,:,0] = noisy[:,:,0] + gauss*noisy[:,:,0]*0.01
    noisy[:,:,1] = noisy[:,:,1] + gauss*noisy[:,:,1]*0.01
    noisy[:,:,2] = noisy[:,:,2] + gauss*noisy[:,:,2]*0.01
    ...
    new_img.save('./data/stl10_binary/n_images/'+str(i)+'.png')
